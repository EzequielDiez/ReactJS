...
const NavBar = () => {
    ...
    return (
        <Navbar className="navbar navbar-expand-lg bg-white p-4" id="navbar">
            <Navbar.Brand as={Link} to="/"  className="navbar-brand"><img src="../logo-online.png" alt="logoheader"/></Navbar.Brand>
            <Navbar.Toggle aria-controls="basic-navbar-nav"/>
            <Navbar.Collapse className="collapse navbar-collapse justify-content-end fs-4" id="navbarNav">
                <Nav>
